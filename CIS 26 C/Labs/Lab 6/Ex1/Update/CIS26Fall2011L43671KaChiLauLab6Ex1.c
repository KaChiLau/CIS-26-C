...
int main () {
	...
	do {
		...
		case 1:
			...
			extractLargestDigitKaChiLau(ary, 100);
			break;
		case 2:
...
int extractLargestDigitKaChiLau(int ary[], int size) {
	...
	int *ptr2 = realloc(ptr, sizeof(int) * 10);
...
int displayDigitOccurrenceKaChiLau(int ary2[], int size) {
	...
	scanf_s("%d", &klfinteger);

	printf("      Second integer : ");
	scanf_s("%d", &klsinteger);
	...
	printf("\n  Total number of occurrence(s) for ");
	printf("all digit(s) : %d\n", kltotal);
